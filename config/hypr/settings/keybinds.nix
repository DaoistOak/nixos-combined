{ config, pkgs, ... }:
{
  wayland.windowManager.hyprland.extraConfig = ''
    ...
    bind = $mod, Period, exec, plasma-emojier #"Emoji picker"
    ...
    bind = $mod ALT, S, exec, hyprpanel t settings-dialog #"Settings dialog"
    bind = $mod, Q, exec, hyprpanel t dashboardmenu #"Dashboard menu"
    bind = $mod, M, exec, hyprpanel t mediamenu #"Media menu"

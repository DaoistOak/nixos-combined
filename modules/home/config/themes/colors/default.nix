...
let
  ...
  # is a 2-colour gradient (theme primary -> secondary) that the border-angle
  # daemon (hypr/scripts/border-angle.sh) rotates toward the cursor at runtime.
  ...
  hyprlandTheme =
    ...
    ''
      ...
      -- Theme: ${defaultTheme} / ${defaultFlavor} / ${defaultAccent}
      return {
        active_border = { c1 = "${x r.accent}", c2 = "${x secondary}", angle = 0 },

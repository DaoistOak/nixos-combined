# Generated by Powerlevel10k configuration wizard on 2026-09-01 at 18:50 +0545.
...
() {
  ...
  # Fallback only; theme-switcher overrides this at load with the ANSI palette
  # slot (0-15) nearest to the active accent (see p10k reload block below).
  ...
  # Runtime theme overrides — rewritten by scripts/theme on `./theme set ...`
  # (e.g. the ANSI palette slot for the active accent). Sourced before reload
  # so `p10k reload` below picks the values up.
  [[ -f ~/.config/theme-switcher/p10k-theme.zsh ]] && source ~/.config/theme-switcher/p10k-theme.zsh

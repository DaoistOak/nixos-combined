...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=0x1e1e2e
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=0x1e1e2e
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=0x1e1e2e
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=0x1e1e2e
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=0x1e1e2e
  ...
  # conditions under which a tool gets hidden. Parameters can hi   de tools but not unhide them. If at
